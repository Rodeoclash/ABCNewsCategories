...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4393__auto__,writer__4394__auto__,opt__4395__auto__){
return cljs.core._write(writer__4394__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_27581 = (0);
while(true){
if((i_27581 < arr.length)){
(arr[i_27581] = null);

var G__27582 = (i_27581 + (1));
i_27581 = G__27582;
continue;
} else {
}
...
var i_27594 = (self__.level + (1));
while(true){
if((i_27594 <= (new_level + (1)))){
(update[i_27594] = self__.header);
...
var i_27596 = (0);
while(true){
if((i_27596 <= self__.level)){
var links_27597 = (update[i_27596]).forward;
if(((links_27597[i_27596]) === x__$1)){
(links_27597[i_27596] = (x__$1.forward[i_27596]));

var G__27598 = (i_27596 + (1));
i_27596 = G__27598;
continue;
} else {
var G__27599 = (i_27596 + (1));
i_27596 = G__27599;
continue;
}
} else {
...
if(!((nx == null))){
var G__27601 = nx;
var G__27602 = (level__$1 - (1));
x = G__27601;
level__$1 = G__27602;
continue;
} else {
var G__27603 = x;
var G__27604 = (level__$1 - (1));
x = G__27603;
level__$1 = G__27604;
continue;
}
...
var G__27606 = nx;
var G__27607 = (level__$1 - (1));
x = G__27606;
level__$1 = G__27607;
continue;
} else {
var G__27608 = x;
var G__27609 = (level__$1 - (1));
x = G__27608;
level__$1 = G__27609;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4393__auto__,writer__4394__auto__,opt__4395__auto__){
return cljs.core._write(writer__4394__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__3806__auto__ = (cljs.core.truth_((function (){var and__3794__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3806__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__3806__auto__,timeout__$1,me))
,msecs);
