...
if(!((function (){var G__24737 = app_db;
if(G__24737){
...
return G__24737.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__24737.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__24737);
} else {
return false;
}
}
...
path.cljs$lang$applyTo = (function (arglist__24743){
...
//# sourceMappingURL=middleware.js.map?rel=1429446761134