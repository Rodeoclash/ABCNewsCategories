...
tailrecursion.cljson.EncodeTagged = (function (){var obj21350 = {};
return obj21350;
})();
...
return (function (){var or__12773__auto__ = (tailrecursion.cljson._encode[goog.typeOf(x__13417__auto__)]);
if(or__12773__auto__){
return or__12773__auto__;
} else {
var or__12773__auto____$1 = (tailrecursion.cljson._encode["_"]);
...
var G__21351 = i__$1;
var G__21352 = cljs.core.rest.call(null,c);
i = G__21351;
c = G__21352;
continue;
} else {
...
var temp__4124__auto__ = (function (){var and__12761__auto__ = cljs.core._STAR_print_meta_STAR_;
...
return G__21356.tailrecursion$cljson$EncodeTagged$;
}
})())){
return true;
} else {
if((!G__21356.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,tailrecursion.cljson.EncodeTagged,G__21356);
} else {
return false;
}
}
...
if((cljs.core.map_QMARK_.call(null,x)) && (!((function (){var G__21358 = x;
if(G__21358){
var bit__13454__auto__ = (G__21358.cljs$lang$protocol_mask$partition0$ & (67108864));
if((bit__13454__auto__) || (G__21358.cljs$core$IRecord$)){
return true;
} else {
if((!G__21358.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__21358);
} else {
return false;
}
}
...
var or__12773__auto__ = tailrecursion.cljson.interpret.call(null,x);
if(cljs.core.truth_(or__12773__auto__)){
return or__12773__auto__;
} else {
...
var G__21362 = (i + (1));
var G__21363 = len;
var G__21364 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__21362;
len = G__21363;
out = G__21364;
continue;
...
var G__21365 = (i + (2));
var G__21366 = len;
var G__21367 = cljs.core.assoc_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])),tailrecursion.cljson.decode.call(null,(o[(i + (1))])));
i = G__21365;
len = G__21366;
out = G__21367;
continue;
...
if((i > (0))){
var G__21368 = (i - (1));
var G__21369 = cljs.core.conj.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__21368;
out = G__21369;
continue;
} else {
...
var G__21370 = (i + (1));
var G__21371 = len;
var G__21372 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__21370;
len = G__21371;
out = G__21372;
continue;
...
break;
default:
var temp__4124__auto__ = (function (){var or__12773__auto__ = cljs.core.get.call(null,cljs.core.deref.call(null,cljs.reader._STAR_tag_table_STAR_),tag);
if(cljs.core.truth_(or__12773__auto__)){
return or__12773__auto__;
} else {
...
//# sourceMappingURL=cljson.js.map?rel=1429501238814