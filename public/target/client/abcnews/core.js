...
return ajax.core.POST.call(null,"/users.json",cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__20461_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"created-user","created-user",1322326133),p1__20461_SHARP_], null));
})], null),abcnews.core.request_options));
});
abcnews.core.get_current_user = (function get_current_user(){
return ajax.core.GET.call(null,"/current_user.json",cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__20462_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fetched-current-user","fetched-current-user",1654888703),p1__20462_SHARP_], null));
})], null),abcnews.core.auth_header.call(null),abcnews.core.request_options));
});
abcnews.core.get_stories = (function get_stories(){
return ajax.core.GET.call(null,"/stories.json",cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__20463_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fetched-stories","fetched-stories",-468112560),p1__20463_SHARP_], null));
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"created-story-user-interest","created-story-user-interest",1651134579),p1__20464_SHARP_], null));
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"create-user","create-user",1923675328),(function (db,p__20465){
var vec__20466 = p__20465;
var _ = cljs.core.nth.call(null,vec__20466,(0),null);
abcnews.core.create_user.call(null);

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"created-user","created-user",1322326133),(function (db,p__20467){
var vec__20468 = p__20467;
var _ = cljs.core.nth.call(null,vec__20468,(0),null);
var user = cljs.core.nth.call(null,vec__20468,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"fetch-current-user","fetch-current-user",316816635),(function (db,p__20469){
var vec__20470 = p__20469;
var _ = cljs.core.nth.call(null,vec__20470,(0),null);
abcnews.core.get_current_user.call(null);

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"fetched-current-user","fetched-current-user",1654888703),(function (db,p__20471){
var vec__20472 = p__20471;
var _ = cljs.core.nth.call(null,vec__20472,(0),null);
var user = cljs.core.nth.call(null,vec__20472,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"fetch-stories","fetch-stories",-624675135),(function (db,p__20473){
var vec__20474 = p__20473;
var _ = cljs.core.nth.call(null,vec__20474,(0),null);
abcnews.core.get_stories.call(null);

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"fetched-stories","fetched-stories",-468112560),(function (db,p__20475){
var vec__20476 = p__20475;
var _ = cljs.core.nth.call(null,vec__20476,(0),null);
var stories = cljs.core.nth.call(null,vec__20476,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"create-story-user-interest","create-story-user-interest",1849203022),(function (db,p__20477){
var vec__20478 = p__20477;
var _ = cljs.core.nth.call(null,vec__20478,(0),null);
var story = cljs.core.nth.call(null,vec__20478,(1),null);
var interest_amount = cljs.core.nth.call(null,vec__20478,(2),null);
abcnews.core.create_story_user_interest.call(null,story,interest_amount);

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"created-story-user-interest","created-story-user-interest",1651134579),(function (db,p__20479){
var vec__20480 = p__20479;
var _ = cljs.core.nth.call(null,vec__20480,(0),null);
var story_user = cljs.core.nth.call(null,vec__20480,(1),null);
re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fetch-current-user","fetch-current-user",316816635)], null));
...
], null),"Set interest (0)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (story_id){
return (function (){
...
], null),"Set interest (0.25)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (story_id){
return (function (){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"create-story-user-interest","create-story-user-interest",1849203022),story,0.5], null));
});})(story_id))
], null),"Set interest (0.50)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (story_id){
return (function (){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"create-story-user-interest","create-story-user-interest",1849203022),story,0.75], null));
});})(story_id))
], null),"Set interest (0.75)"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (story_id){
return (function (){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"create-story-user-interest","create-story-user-interest",1849203022),story,1.0], null));
});})(story_id))
], null),"Set interest (1.00)"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),story_id], null));
});
...
return (function iter__20486(s__20487){
return (new cljs.core.LazySeq(null,((function (stories,story_users){
return (function (){
var s__20487__$1 = s__20487;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__20487__$1);
if(temp__4126__auto__){
var s__20487__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__20487__$2)){
var c__13527__auto__ = cljs.core.chunk_first.call(null,s__20487__$2);
var size__13528__auto__ = cljs.core.count.call(null,c__13527__auto__);
var b__20489 = cljs.core.chunk_buffer.call(null,size__13528__auto__);
if((function (){var i__20488 = (0);
while(true){
if((i__20488 < size__13528__auto__)){
var story = cljs.core._nth.call(null,c__13527__auto__,i__20488);
cljs.core.chunk_append.call(null,b__20489,abcnews.core.story_item.call(null,story,cljs.core.first.call(null,cljs.core.filter.call(null,((function (i__20488,story,c__13527__auto__,size__13528__auto__,b__20489,s__20487__$2,temp__4126__auto__,stories,story_users){
return (function (p1__20481_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(story),new cljs.core.Keyword(null,"story_id","story_id",899973475).cljs$core$IFn$_invoke$arity$1(p1__20481_SHARP_));
});})(i__20488,story,c__13527__auto__,size__13528__auto__,b__20489,s__20487__$2,temp__4126__auto__,stories,story_users))
,story_users))));

var G__20490 = (i__20488 + (1));
i__20488 = G__20490;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__20489),iter__20486.call(null,cljs.core.chunk_rest.call(null,s__20487__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__20489),null);
}
} else {
var story = cljs.core.first.call(null,s__20487__$2);
return cljs.core.cons.call(null,abcnews.core.story_item.call(null,story,cljs.core.first.call(null,cljs.core.filter.call(null,((function (story,s__20487__$2,temp__4126__auto__,stories,story_users){
return (function (p1__20481_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(story),new cljs.core.Keyword(null,"story_id","story_id",899973475).cljs$core$IFn$_invoke$arity$1(p1__20481_SHARP_));
});})(story,s__20487__$2,temp__4126__auto__,stories,story_users))
,story_users))),iter__20486.call(null,cljs.core.rest.call(null,s__20487__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=core.js.map?rel=1429744490708